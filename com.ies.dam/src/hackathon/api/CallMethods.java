...
public class CallMethods<T>  {
    ...
    public String get(String url){
        Call<ResponseBody> call = service.getCall(url, Parameters.GROUP);
        try {
    ...
    public String post(String url, RequestBody data){
        Call<ResponseBody> call = service.postCall(url, data, Parameters.GROUP);
        try {
            return call.execute().body().string();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public String put(String url, RequestBody data){
        Call<ResponseBody> call = service.putCall(url, data, Parameters.GROUP);
        try {
            return call.execute().body().string();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public String delete(String url){
        Call<ResponseBody> call = service.deleteCall(url, Parameters.GROUP);
        try {
            return call.execute().body().string();
        } catch (IOException e) {
            e.printStackTrace();
